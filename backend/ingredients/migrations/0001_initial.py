    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=18, samples=[('#49b64e', 'green'), ('#e26c2d', 'orange'), ('#8775d2', 'purple')], verbose_name='цвет тега')),
